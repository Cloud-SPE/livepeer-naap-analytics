...
- Existing building blocks to reuse first: [`tests/python/scripts/run_clickhouse_query_pack.py`](../../tests/python/scripts/run_clickhouse_query_pack.py), [`tests/python/scripts/run_clickhouse_data_tests.py`](../../tests/python/scripts/run_clickhouse_data_tests.py), and [`tests/python/scripts/run_scenario_test_harness.py`](../../tests/python/scripts/run_scenario_test_harness.py).
