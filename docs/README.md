...
- GPU attribution and lifecycle semantics: [docs/workflows/FLINK_LIFECYCLE_STATE_MACHINES.md](workflows/FLINK_LIFECYCLE_STATE_MACHINES.md)
...
- Canonical docs inventory (script + reference): [docs/automation/DOCS_TOOLING.md](automation/DOCS_TOOLING.md), [docs/automation/SCRIPTS_REFERENCE.md](automation/SCRIPTS_REFERENCE.md)
- Consolidation and migration priorities: [docs/references/ISSUES_BACKLOG.md](references/ISSUES_BACKLOG.md)
