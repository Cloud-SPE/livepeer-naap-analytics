with {{ latest_value_cte('latest_slices', 'naap.canonical_streaming_gpu_metrics_hourly_store', ['org', 'window_start'], 'refresh_run_id') }}
select
    s.window_start,
    s.org,
...
from naap.canonical_streaming_gpu_metrics_hourly_store s
