...
-- Derived from api_current_orchestrator's pipeline_model_pairs column
-- (already materialized on every resolver tail). Replaces a DISTINCT
-- scan of api_observed_capability_offer.
