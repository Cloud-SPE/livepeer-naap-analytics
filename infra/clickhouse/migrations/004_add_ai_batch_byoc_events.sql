-- Migration 004: Add AI Batch and BYOC event type tracking
...
CREATE TABLE IF NOT EXISTS naap.normalized_ai_batch_job (
  `event_id` String,
...
CREATE TABLE IF NOT EXISTS naap.normalized_ai_llm_request (
  `event_id` String,
  `event_ts` DateTime64(3, 'UTC'),
  `org` LowCardinality(String),
  `gateway` String,
...
CREATE TABLE IF NOT EXISTS naap.normalized_byoc_job (
  `event_id` String,
  `event_ts` DateTime64(3, 'UTC'),
  `org` LowCardinality(String),
  `gateway` String,
...
CREATE TABLE IF NOT EXISTS naap.normalized_byoc_auth (
  `event_id` String,
  `event_ts` DateTime64(3, 'UTC'),
  `org` LowCardinality(String),
  `gateway` String,
...
CREATE TABLE IF NOT EXISTS naap.normalized_worker_lifecycle (
  `event_id` String,
  `event_ts` DateTime64(3, 'UTC'),
  `org` LowCardinality(String),
  `gateway` String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS naap.mv_normalized_ai_batch_job
...
CREATE MATERIALIZED VIEW IF NOT EXISTS naap.mv_normalized_ai_llm_request
...
CREATE MATERIALIZED VIEW IF NOT EXISTS naap.mv_normalized_byoc_job
...
CREATE MATERIALIZED VIEW IF NOT EXISTS naap.mv_normalized_byoc_auth
...
CREATE MATERIALIZED VIEW IF NOT EXISTS naap.mv_normalized_worker_lifecycle
...
CREATE MATERIALIZED VIEW IF NOT EXISTS naap.mv_normalized_byoc_payment
