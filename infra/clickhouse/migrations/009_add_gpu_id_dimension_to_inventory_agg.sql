...
CREATE TABLE naap.canonical_latest_orchestrator_pipeline_inventory_agg
(
...
PARTITION BY org
ORDER BY (org, orch_address, pipeline_id, model_id, gpu_id)
SETTINGS index_granularity = 8192;

CREATE MATERIALIZED VIEW naap.mv_canonical_latest_orchestrator_pipeline_inventory_agg
