...
TRUNCATE TABLE naap.canonical_selection_events;
TRUNCATE TABLE naap.canonical_selection_attribution_decisions;
TRUNCATE TABLE naap.canonical_selection_attribution_current;
TRUNCATE TABLE naap.canonical_orch_capability_versions;
TRUNCATE TABLE naap.canonical_orch_capability_intervals;
...
TRUNCATE TABLE naap.canonical_session_current_store;
TRUNCATE TABLE naap.canonical_session_demand_input_current;
TRUNCATE TABLE naap.canonical_status_hours_store;
TRUNCATE TABLE naap.canonical_status_samples_recent_store;
TRUNCATE TABLE naap.canonical_active_stream_state_latest_store;
TRUNCATE TABLE naap.canonical_payment_links_store;
TRUNCATE TABLE naap.canonical_ai_batch_job_store;
TRUNCATE TABLE naap.canonical_byoc_job_store;

TRUNCATE TABLE naap.api_payment_hourly_store;
TRUNCATE TABLE naap.api_network_demand_by_org_store;
TRUNCATE TABLE naap.api_gpu_network_demand_by_org_store;
TRUNCATE TABLE naap.api_sla_compliance_inputs_by_org_store;
TRUNCATE TABLE naap.api_sla_compliance_by_org_store;
TRUNCATE TABLE naap.api_sla_compliance_store;
TRUNCATE TABLE naap.api_gpu_metrics_by_org_store;

TRUNCATE TABLE naap.selection_attribution_changes;
TRUNCATE TABLE naap.session_current_changes;
TRUNCATE TABLE naap.status_hour_changes;

TRUNCATE TABLE naap.resolver_backfill_runs;
TRUNCATE TABLE naap.resolver_dead_letters;
TRUNCATE TABLE naap.resolver_dirty_partitions;
TRUNCATE TABLE naap.resolver_dirty_orchestrators;
TRUNCATE TABLE naap.resolver_dirty_selection_events;
TRUNCATE TABLE naap.resolver_dirty_sessions;
TRUNCATE TABLE naap.resolver_dirty_windows;
TRUNCATE TABLE naap.resolver_repair_requests;
TRUNCATE TABLE naap.resolver_runs;
TRUNCATE TABLE naap.resolver_runtime_state;
TRUNCATE TABLE naap.resolver_window_claims;
TRUNCATE TABLE naap.resolver_query_event_ids;
TRUNCATE TABLE naap.resolver_query_identities;
TRUNCATE TABLE naap.resolver_query_selection_event_ids;
TRUNCATE TABLE naap.resolver_query_session_keys;
TRUNCATE TABLE naap.resolver_query_window_slices;
SQL
